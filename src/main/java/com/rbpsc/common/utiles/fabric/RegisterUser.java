...
public class RegisterUser {
    public static void register() throws Exception {
        ...
        if (wallet.get("javaAppUser") != null) {
            log.info("An identity for the user \"javaAppUser\" already exists in the wallet");
            return;
        }
        ...
        log.info("Successfully enrolled user \"javaAppUser\" and imported it into the wallet");
    }
}
