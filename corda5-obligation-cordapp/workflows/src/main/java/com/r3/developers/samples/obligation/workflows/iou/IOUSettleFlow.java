package com.r3.developers.samples.obligation.workflows.iou;
...
public class IOUSettleFlow implements ClientStartableFlow {
    ...
    public String call(ClientRequestBody requestBody) {
        ...
        try {
            ...
            return flowEngine.subFlow(new FinalizeDrugLifecycleFlow.FinalizeDrugLifecycle(signedTransaction, Arrays.asList(lenderInfo.getName())));
        }
